    ...
    <div className="mt-[100px] xs:text-xs">
      ...
      <div className=" lg:hidden xl:hidden 2xl:hidden cursor-pointer xs:flex xs:flex-col md:justify-items-stretch ">
            <div className="z-10">
              ...
              <div 
                style={{ backgroundImage: `url(${Book})`, backgroundSize: 'cover', backgroundColor:'grey', backgroundBlendMode: 'multiply' }}
      ...
      <div className="lg:flex lg:flex-row cursor-pointer xs:flex xs:flex-col-reverse  lg:hidden xl:hidden 2xl:hidden">
        <div className="z-10 xs:mt-[30px]">
          ...
          <div
            style={{ backgroundImage: `url(${Transact})`, backgroundSize: 'cover', backgroundColor:'grey', backgroundBlendMode: 'multiply' }}
