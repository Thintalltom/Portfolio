...
const Info = () => {
  return (
    <div name='about' className="w-full h-full  p-4 2xl:p-[100px] lg:mt-[150px] xs:mt-[40px] md:mt-[500px] sm:mt-[500px] ">
      <div>
        ...
        <div className="lg:flex lg:gap-4 lg:flex-row xs:flex xs:flex-col md:mt-[30px] sm:mt-[30px]">
          ...
          <div className="md:justify-center">
            <motion.div className="lg:w-[300px] md:ml-16 lg:h-75 border-2 md:ml-4 md:w-[500px] sm:w-[400px] border-lime-500 p-2 lg:mt-[40px] md:mx-[40px] rounded xs:p-1 xs:w-[200px] xs:mt-[80px] xs:mx-auto">
              <img
                src={profile}
