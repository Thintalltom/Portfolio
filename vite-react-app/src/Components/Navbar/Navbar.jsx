...
const Navbar = () => {
  ...
  <div className='h-[70px] bg-sky-950 drop-shadow-lg  items-center justify-between p-4 flex font-sans'>
      ...
      {/*small screen*/}
      <div className={open ? 'hidden' : `flex-col flex text-center justify-center items-center gap-9 p-4 xs:w-full 2xl:hidden lg:hidden   xs:h-screen md:h-screen bg-slate-200 absolute top-0 left-0`}>
          {list.map((list) => (
