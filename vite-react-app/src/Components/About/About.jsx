      ...
      <div className="bg-zinc-950    h-[30rem]">
        <div className="flex xs:flex-col lg:flex-row sm:flex-col  md:flex-col items-center justify-between p-[50px]">
          <div>
            ...
            <a href="https://drive.google.com/file/d/12Y1zwPnIrlljrb_5JUfaRBCKYBI_KAwo/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button className="bg-zinc-800 p-[10px] mt-[20px] w-[200px]">Resume</button></a>  
